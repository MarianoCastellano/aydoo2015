...
public class SuggestVisitsTest {
	...
	public void suggestedVisitsShouldSuggestedWhenHasMoneyEnough() {
		User joseph = new User(1000, 3600);
	...
	private Set<Attraction> createAttractions() {
		...
		Attraction landscape = new Attraction(10, 20, 500, 3600);
		Attraction tasing = new Attraction(20, 20, 1500, 3600);
		Attraction adventure = new Attraction(55, 33, 2000, 3600);
